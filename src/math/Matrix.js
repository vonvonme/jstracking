 ...
 * @static
 */
Matrix.clone = function(src, width, height){
 ...
 * @static
 */
Matrix.mulScalar = function(scalar, src){
 ...
 * @static
 */
Matrix.calcCovarMatrix = function(src){
